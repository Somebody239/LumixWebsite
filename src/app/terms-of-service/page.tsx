        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
            <div className="bg-muted/30 p-6 rounded-lg">
              <p className="mb-2">
                Please read these Terms of Service ("Terms") carefully before using the Lumix Design website and services.
              </p>
              <p className="mb-2">
            ...
            <section>
              ...
              <p>
                Lumix Design provides web design and development services including:
              </p>
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <ul className="space-y-2">
                  <li>• Business website design and development</li>
                  <li>• E-commerce store creation</li>
                  <li>• Portfolio and landing page design</li>
                </ul>
                <ul className="space-y-2">
                  <li>• Content platform development</li>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-sm">
                    Our website, original content, features, and functionality are the exclusive property of Lumix Design and its licensors.
                ...
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-sm">
                    You retain ownership of any content you provide to us. By working with us, you grant Lumix Design a license to use,
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="border border-muted p-4 rounded-lg">
                    <h3 className="font-semibold mb-2">By Lumix Design</h3>
            ...
            <section>
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 p-4 rounded-lg">
                <p className="text-sm">
                  Lumix Design's liability is limited to the amount paid for the specific service in question.
            ...
            <section className="bg-primary/5 p-6 rounded-lg">
              ...
              <div className="text-center">
                <p className="font-semibold">Lumix Design</p>
                <p>Email: <a href="mailto:lumixwebdesign@gmail.com" className="text-primary hover:underline">lumixwebdesign@gmail.com</a></p>
              </div>
            </section>
          </div>
        </div>
